...
问题很容易在 O(N^2) 复杂度下解决，只需要遍历每个元素即可。

## O(NlogN)

使用我们在LeetCode 162题中，解决一维数组峰值的二分法，可以把复杂度降到 O(NlogN)

## O(N)

Stack Overflow上给的一种解法
...
---
[2D peak finding algorithm in O(n) worst case time?](https://stackoverflow.com/questions/23120300/2d-peak-finding-algorithm-in-on-worst-case-time)
